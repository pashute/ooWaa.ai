...
#### 0.2 Instructions for AI (Calude Sonnet 4.6) 
...
#### 2.3 Logic First, Statistic Model Secondary Tool

* 2.3.1 Smart context - modular knowledge bases
* 2.3.2 Smart retrieval - complex task planning and execution on the fly

### 3. Smart Orchestrated Tooling

* 3.1 Logic first accessor orchestration tool — TAISKER
* 3.2 AI controlled sequence and procedural logic
* 3.3 AI activated dynamic tool choice
* 3.4 On the fly AI self coding — DYNAMAIT

### 4. Paradigm Knowledge Bases — IamWim
LLM Alternative:  A new method of knowledge graph buildup with no LLM
* 4.1 Emergent modular knowledge base. 
